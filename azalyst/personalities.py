...
PERSONALITIES: dict[MarketRegime, Personality] = {
    ...
    MarketRegime.STRONG_UPTREND: Personality(
        ...
        sl_max_pct=0.037,       # REDUCED from 0.04 (user requested 3.7%)
        trailing_enabled=True,
        trail_trigger_pct=0.04,
        trail_distance_pct=0.04,# INCREASED slightly from 0.035
        max_open_trades=5,
    ...
    MarketRegime.WEAK_DOWNTREND: Personality(
        ...
        trail_trigger_pct=0.0,
        trail_distance_pct=0.0,
        max_open_trades=0,      # DISABLED to reduce drawdown in choppy markets
        max_same_direction=0,
        risk_multiplier=0.0,    # DISABLED to protect capital
        min_agreement=1,
        weighted_threshold=5.0,
        directional_bias=-1,
        scan_limit=20,
